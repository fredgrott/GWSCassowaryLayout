...
Soft fork of Alecx Birkett's Android Cassowary Layout
...
```groovy
compile 'com.github.shareme:GWSCassowaryLayout:{latest-release-number}@aar'
```
...
[Alex Birkett's Android Cassowary Layout]()
